...
UnsortedEntriesWithLeadingComment = SetupCfgExample(
    correctly_formatted="""# Copyright 1701 James T. Kirk
...
universal = True
""",
    incorrectly_formatted="""# Copyright 1701 James T. Kirk
...
all_examples: List[SetupCfgExample] = [
    UnsortedEntries,
    UnsortedEntriesWithInlineComments,
    UnsortedEntriesWithCommentLines,
    UnsortedEntriesWithLeadingComment,
]
